<?php
    ...
    $i = 0;
    while ($i < 6) {      
       $asset_type = $mysqli->real_escape_string($_POST["ast" . $i]);
       $asset_value = $mysqli->real_escape_string($_POST["asv" . $i]);
    ...
    //$query = "INSERT INTO ASSETS (ASSET_TYPE_ID, ASSET_VALUE, NAME_ID) VALUES ('$asset_type_id', 
